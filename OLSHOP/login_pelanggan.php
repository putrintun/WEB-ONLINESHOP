...
<html lang="en">
    ...
    <body>
        <div class="login">
            <form action="proses_login_pelanggan.php" method="post" class="form">
                <img src="ASSETS/RANDOM/LOGIN.png" alt="">
                <h2><b>LOGIN PELANGGAN</b></h2>
                ...
                <center><p>Don't have an Account ? <a href="tambah_pelanggan.php">Sign Up</a></p></center>
            </form>
        </div>
